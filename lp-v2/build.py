...
:root{
  ...
  /* ══ Medida dos subtitulos ══
     ...
     Passam a partilhar uma medida so, presa a do titulo: 62% dela, que
     da 632px. Nao pode ser a medida inteira — 1020px de texto corrido a
     17px sao 126 caracteres por linha, o dobro do que o olho segue sem
     perder o sitio onde ia. A 62% sao 78, dentro da banda que se le bem, e
     a relacao com o titulo por cima passa a ler-se como escolha em vez de
     acaso. Abaixo do ponto em que o titulo deixa de caber, os dois
     encolhem juntos e o subtitulo fica da largura do titulo. */
  --medida-sub: min(calc(var(--medida-max) * .62), var(--medida-titulo));
}
.hero-h1,
